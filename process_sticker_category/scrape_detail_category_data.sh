...
categories=("mostpopular" "expressions" "tvseries" "characters" "summer" "movies" "animatedstickers" "sports" "food" "bbmfamily" "stickerfactory" "animalsandpets" "favindonesia" "loveandromance" "emoji" "workandoffice" "classics" "games")
